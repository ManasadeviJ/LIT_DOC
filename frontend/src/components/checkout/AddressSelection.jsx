...
const StepLoginInfo = () => {
  return (
    <div className="step-box login-step-box">
      <div className="step-header">
        <span className="step-number">1</span>
        <span className="step-title">LOGIN ✓</span>
      </div>
      <div className="login-details">
        <span className="username">LUXURYINTATSE</span>
        <span className="phone">+91 9874561230</span>
      </div>
    </div>
  );
};
    ...
    <StepLoginInfo />
      <div className="step-box">
        <div className="step-header">
          ...
          <span className="step-title">Select Address</span>
        </div>
    </div>
